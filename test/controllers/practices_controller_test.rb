...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { date: @practice.date, length: @practice.length, name: @practice.name, notes: @practice.notes, team_id: @practice.team_id, user_id: @practice.user_id } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { date: @practice.date, length: @practice.length, name: @practice.name, notes: @practice.notes, team_id: @practice.team_id, user_id: @practice.user_id } }
